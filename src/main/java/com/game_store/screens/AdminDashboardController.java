...
public class AdminDashboardController {
    ...
    public void initialize() {
        ...
        // ===== إعداد أعمدة الجدول =====
        colFullName
                .setCellValueFactory(c -> new javafx.beans.property.SimpleStringProperty(c.getValue().getFull_name()));
        colUsername
            ...
            private final ComboBox<String> combo = new ComboBox<>();
            {
                ...
                combo.setOnAction(e -> {
                    ...
                    if (u != null) {
                        ...
                        String json = "{\"user_role\":\"" + u.getUser_role() + "\",\"is_developer\":"
                                + u.isIs_developer() + "}";
                        boolean success = ApiClient.updateUser(u.getId(), json);
                        if (!success)
                            System.out.println("Failed to update role for: " + u.getUsername());
                    }
                });
            }
                ...
                btn.setOnAction(e -> {
                    ...
                    if (u != null) {
                        ...
                        if (success)
                            ...
                            System.out.println("Failed to delete: " + u.getUsername());
                    }
                });
            }
